...
/* harmony import */ var _models_offer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/offer.js */ "./src/models/offer.js");
...
class API {
  ...
  updateEvent(id, data) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parse);
  }
  ...
  getEvents() {
    return this._load({url: Url.EVENTS})
      .then((response) => response.json())
      .then(_models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseAll);
  }

  getDestinations() {
    return this._load({url: Url.DESTINATIONS})
      .then((response) => response.json())
      .then(_models_destination_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseAll);
  }

  getOffers() {
    return this._load({url: Url.OFFERS})
      .then((response) => response.json())
      .then(_models_offer_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseAll);
  }
}
...
class Provider {
  ...
  getEvents() {
    ...
    return Promise.resolve(_models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseAll(Object.values(events)));
  }
  ...
  createEvent(data) {
    ...
    this._synced = false;
    const newLocalEventId = Object(nanoid__WEBPACK_IMPORTED_MODULE_3__["nanoid"])();
    const newLocalEvent = _models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(data, {id: newLocalEventId}));
  ...
  updateEvent(id, data) {
    ...
    this._synced = false;
    const localEvent = _models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(data, {id}));
  ...
  getDestinations() {
    ...
    return Promise.resolve(_models_destination_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseAll(destinations));
  }
  ...
  getOffers() {
    ...
    return Promise.resolve(_models_offer_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseAll(offers));
  }
...
/*!**************************************!*\
  !*** ./src/components/event-form.js ***!
  \**************************************/
/*! exports provided: createEventFormTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _controllers_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/event.js */ "./src/controllers/event.js");
/* harmony import */ var _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./abstract-smart-component.js */ "./src/components/abstract-smart-component.js");
...
/* harmony import */ var flatpickr_dist_plugins_labelPlugin_labelPlugin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! flatpickr/dist/plugins/labelPlugin/labelPlugin */ "./node_modules/flatpickr/dist/plugins/labelPlugin/labelPlugin.js");
/* harmony import */ var flatpickr_dist_plugins_labelPlugin_labelPlugin__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_plugins_labelPlugin_labelPlugin__WEBPACK_IMPORTED_MODULE_5__);
...
const createEventTypeItems = (eventNames, checkedEventName) => {
  return eventNames.map((name) => {
    ...
    const eventNameUpperCase = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstLetterUppercase"])(eventName);
...
const createEventFormTemplate = (eventItem, eventsModel, mode, {newEventName, newDestination}) => {
  const destinations = eventsModel.getDestinations();
  const modelOffers = eventsModel.getOffers();

  const isCreateMode = mode === _controllers_event_js__WEBPACK_IMPORTED_MODULE_2__["Mode"].CREATE ? true : false;
  ...
  const pictures = destinationName ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["findDestination"])(destinations, destinationName).images : [];
  const newImages = destinationName ? pictures : [];
  const destinationImages = isCreateMode ? newImages : images;

  const descriptionText = destinationName ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["findDestination"])(destinations, destinationName).description : ``;
  ...
  const offerObject = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["findOffers"])(modelOffers, eventName);
  ...
  const startTime = `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getDateTime"])(startDate, true)} ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(startDate)}`;
  const endTime = `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getDateTime"])(endDate, true)} ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(endDate)}`;
  ...
  const preposition = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["createPreposition"])(eventName);
  const transportTypeNames = Object.keys(_const_js__WEBPACK_IMPORTED_MODULE_1__["EventType"]).filter((key) => _const_js__WEBPACK_IMPORTED_MODULE_1__["EventType"][key] === `move`);
  const activityTypeNames = Object.keys(_const_js__WEBPACK_IMPORTED_MODULE_1__["EventType"]).filter((key) => _const_js__WEBPACK_IMPORTED_MODULE_1__["EventType"][key] === `stop`);
...
class EventForm extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  setAddToFavoritesHandler(handler) {
    if (this._mode === _controllers_event_js__WEBPACK_IMPORTED_MODULE_2__["Mode"].CREATE) {
      return;
    }
  ...
  _subscribeOnEvents() {
    ...
    this
      ...
      .addEventListener(`change`, (evt) => {
        ...
        const destination = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["findDestination"])(destinations, userInput);
  ...
  _applyFlatpickr() {
    ...
    const config = {
      ...
      altFormat: `d/m/Y H:i`,
      enableTime: true,
      plugins: [new flatpickr_dist_plugins_labelPlugin_labelPlugin__WEBPACK_IMPORTED_MODULE_5___default.a({})],
    ...
    this._flatpickr = {};
    this._flatpickr.startDate = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(startTimeElement, Object.assign(config, {defaultDate: this._eventItem.startDate}));
    this._flatpickr.endDate = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(endTimeElement, Object.assign(config, {defaultDate: this._eventItem.endDate}));
  }
}
...
/*!**************************************!*\
  !*** ./src/components/event-item.js ***!
  \**************************************/
/*! exports provided: createEventItemTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createEventItemTemplate = (eventItem) => {
  ...
  const nameUpperCase = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstLetterUppercase"])(name);
  const iconName = name;
  const duration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getFormattedDuration"])(startDate, endDate);
  const startDateTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getDateTime"])(startDate);
  const endDateTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getDateTime"])(endDate);
  const startTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(startDate);
  const endTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(endDate);
  const offersTemplate = createOffersTemplate(offers);
  const preposition = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["createPreposition"])(name);
...
class EventItem extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(event) {
    super();
    this._event = event;
  }
...
/*!***********************************!*\
  !*** ./src/components/filters.js ***!
  \***********************************/
/*! exports provided: createFilterTemplate, createFiltersTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createFilterTemplate = ({name: filterName, isChecked}) => {
...
class Filters extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(configs) {
    super();
    this._configs = configs;
    this._current = _const__WEBPACK_IMPORTED_MODULE_1__["FilterName"].EVERYTHING;
...
/*!********************************!*\
  !*** ./src/components/menu.js ***!
  \********************************/
/*! exports provided: MenuItem, createMenuTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***********************************!*\
  !*** ./src/components/message.js ***!
  \***********************************/
/*! exports provided: createMessageTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createMessageTemplate", function() { return createMessageTemplate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Message; });
/* harmony import */ var _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component.js */ "./src/components/abstract-smart-component.js");


const createMessageTemplate = (message, isErrorMessage) => {
  const errorClass = isErrorMessage ? `trip-events__msg--error` : ``;
  return `<p class="trip-events__msg ${errorClass}">${message}</p>`;
};

class Message extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._text = ``;
    this._isError = false;
...
/*!********************************!*\
  !*** ./src/components/sort.js ***!
  \********************************/
/*! exports provided: createSortingTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createSortControls = (sorts) => {
  return sorts.map(({name, isChecked}) => {
    const upperCaseName = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstLetterUppercase"])(name);
    const checked = isChecked ? `checked` : ``;
    return (
...
const createDayTemplate = (current) => {
  const day = current === _const_js__WEBPACK_IMPORTED_MODULE_2__["SortName"].EVENT ? `Day` : ``;
  return `<span class="trip-sort__item  trip-sort__item--day">${day}</span>`;
};

const createSortingTemplate = (sorts, current) => {
...
class Sort extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(configs) {
    super();
    this._configs = configs;
    this._current = _const_js__WEBPACK_IMPORTED_MODULE_2__["SortName"].EVENT;
...
const parseData = (events) => {
  const parsedData = events.reduce((acc, event) => {
    const time = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getDuration"])(event.startDate, event.endDate).asHours();
...
class Stats extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/components/trip-days-item.js":
/*!******************************************!*\
  !*** ./src/components/trip-days-item.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripDaysItem; });
...
const createDayInfoTemplate = (counter, date) => {
  const monthDayString = `${new Date(date).getDate()} ${_const_js__WEBPACK_IMPORTED_MODULE_0__["Months"][new Date(date).getMonth()]}`;
...
class TripDaysItem extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
/*!******************************************!*\
  !*** ./src/components/trip-days-list.js ***!
  \******************************************/
/*! exports provided: createTripDaysTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*************************************!*\
  !*** ./src/components/trip-info.js ***!
  \*************************************/
/*! exports provided: createTripInfoTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createDates = (events) => {
  ...
  const startDate = moment__WEBPACK_IMPORTED_MODULE_1___default()(firstEvent.startDate);
  const endDate = moment__WEBPACK_IMPORTED_MODULE_1___default()(lastEvent.endDate);
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: Months, FilterName, SortName, EventType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SortName", function() { return SortName; });
...
/* harmony import */ var _components_event_item_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/event-item.js */ "./src/components/event-item.js");
/* harmony import */ var _components_event_form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/event-form.js */ "./src/components/event-form.js");
...
const parseFormData = (data, eventsModel, formComponent) => {
  ...
  const {offers} = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["findOffers"])(modelOffers, eventName);
  const eventOffers = parseOffers(formComponent, offers);
  const destination = data.get(`event-destination`);
  const {description} = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["findDestination"])(destinations, destination);
  const {images} = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["findDestination"])(destinations, destination);
...
class EventController {
  ...
  render(event, mode) {
    ...
    this._eventItemComponent = new _components_event_item_js__WEBPACK_IMPORTED_MODULE_0__["default"](event);
    this._eventFormComponent = new _components_event_form_js__WEBPACK_IMPORTED_MODULE_1__["default"](event, this._eventsModel, this._mode);
    ...
    this._eventFormComponent.setSubmitHandler((evt) => {
      ...
      const duration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["getDuration"])(data.startDate, data.endDate).asMilliseconds();
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldEventFormComponent && oldEventItemComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventItemComponent, oldEventItemComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventFormComponent, oldEventFormComponent);
          this._replaceFormToEvent();
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._eventItemComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
        }
        break;
      case Mode.CREATE:
        if (oldEventFormComponent && oldEventItemComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldEventItemComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldEventFormComponent);
        }
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._eventFormComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
        break;
      case Mode.UPDATE:
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventFormComponent, oldEventFormComponent);
        break;
  ...
  _replaceEventToForm() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventFormComponent, this._eventItemComponent);
    this._mode = Mode.EDIT;
  }

  _replaceFormToEvent() {
    this._eventFormComponent.getElement().reset();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventItemComponent, this._eventFormComponent);
    this._mode = Mode.DEFAULT;
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._eventItemComponent);
...
class FiltersController {
  constructor(container, eventsModel) {
    ...
    this._activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterName"].EVERYTHING;
  ...
  render() {
    ...
    const disabledFilters = Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_1__["getDisabledFilters"])(events);

    const filters = Object.keys(_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterName"]).map((filterName) => {
      const isDisabled = disabledFilters[_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterName"][filterName]];
      ...
      return {
        name: _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterName"][filterName],
        isChecked: _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterName"][filterName] === this._activeFilter,
      };
    }).filter((filter) => filter);

    const oldComponent = this._filterComponent;
    this._filterComponent = new _components_filters_js__WEBPACK_IMPORTED_MODULE_3__["default"](filters);
    ...
    if (oldComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    }
  }
...
class SortController {
  constructor(container, eventsModel) {
    ...
    this._activeSort = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortName"].EVENT;

    this._onSortChange = this._onSortChange.bind(this);
  }

  render() {
    const sorts = Object.keys(_const_js__WEBPACK_IMPORTED_MODULE_1__["SortName"]).map((sortName) => {
      return {
        name: _const_js__WEBPACK_IMPORTED_MODULE_1__["SortName"][sortName],
        isChecked: _const_js__WEBPACK_IMPORTED_MODULE_1__["SortName"][sortName] === this._activeSort
      };
    });

    const oldComponent = this._sortComponent;
    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["default"](sorts);
    this._sortComponent.setChangeHandler(this._onSortChange);

    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._sortComponent, oldComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
    }
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._sortComponent);
    this._sortComponent = null;
    this._activeSort = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortName"].EVENT;
  }
...
/* harmony import */ var _components_trip_days_item_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/trip-days-item.js */ "./src/components/trip-days-item.js");
/* harmony import */ var _event_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./event.js */ "./src/controllers/event.js");
/* harmony import */ var _sort_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sort.js */ "./src/controllers/sort.js");
/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter */ "./src/controllers/filter.js");
/* harmony import */ var _components_message_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/message.js */ "./src/components/message.js");
...
class TripController {
  constructor(container, eventsModel, api) {
    ...
    this._newEvent = null;
    this._activeSort = _const_js__WEBPACK_IMPORTED_MODULE_7__["SortName"].EVENT;
  ...
  _onDataChange(eventController, oldData, newData) {
    if (newData === _event_js__WEBPACK_IMPORTED_MODULE_1__["EmptyEvent"]) {
      ...
      if (this._newEvent) {
        this._api.createEvent(newData)
          ...
          .catch(() => {
            eventController.setMode(_event_js__WEBPACK_IMPORTED_MODULE_1__["Mode"].CREATE);
            eventController.onError();
          });
      } else {
        this._api.updateEvent(oldData.id, newData)
          .then((event) => {
            ...
            if (isSuccess) {
              if (controllerMode === _event_js__WEBPACK_IMPORTED_MODULE_1__["Mode"].UPDATE) {
  ...
  render() {
    ...
    if (events.length === 0) {
      this._messageComponent = new _components_message_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(containerElement, this._messageComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
    ...
    const eventsByDate = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["createSortedByDateObject"])(events);
    const sortedByDateKeys = Object.keys(eventsByDate).sort();

    if (this._activeSort === _const_js__WEBPACK_IMPORTED_MODULE_7__["SortName"].EVENT) {
      ...
      tripDaysItemComponents.forEach((component) => {
        ...
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(containerElement, component, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      });
    } else {
      const tripDaysItemComponent = this._createDayItemComponent(events);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(containerElement, tripDaysItemComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      this._shownTripDaysItemComponents.push(tripDaysItemComponent);
    }
  }

  _createDayItemComponent(events, counter, date) {
    const tripDaysItemComponent = new _components_trip_days_item_js__WEBPACK_IMPORTED_MODULE_0__["default"](counter, date);
  ...
  _renderEvents(eventsListElement, events) {
    return events.map((event) => {
      const eventController = new _event_js__WEBPACK_IMPORTED_MODULE_1__["default"](eventsListElement, this._eventsModel, this._onDataChange, this._onViewChange);
      eventController.render(event, _event_js__WEBPACK_IMPORTED_MODULE_1__["Mode"].DEFAULT);
  ...
  createEvent() {
    ...
    this._newEvent = new _event_js__WEBPACK_IMPORTED_MODULE_1__["default"](tripEventsElement, this._eventsModel, this._onDataChange, this._onViewChange);
    this._newEvent.render(_event_js__WEBPACK_IMPORTED_MODULE_1__["EmptyEvent"], _event_js__WEBPACK_IMPORTED_MODULE_1__["Mode"].CREATE);
  ...
  _removeTripDaysComponents() {
    this._shownTripDaysItemComponents.forEach((component) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(component));
    this._shownTripDaysItemComponents = [];
  }

  _removeMessageComponent() {
    if (this._messageComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._messageComponent);
    }
  }
  ...
  _createSortController() {
    const tripEventsElement = document.querySelector(`.trip-events`);
    this._sortController = new _sort_js__WEBPACK_IMPORTED_MODULE_2__["default"](tripEventsElement, this._eventsModel);
    this._sortController.render();
  ...
  _createFiltersController() {
    ...
    this._filtersController = new _filter__WEBPACK_IMPORTED_MODULE_3__["default"](tripControlsElement, this._eventsModel);
...
/* harmony import */ var _components_trip_days_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/trip-days-list.js */ "./src/components/trip-days-list.js");
/* harmony import */ var _components_message_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/message.js */ "./src/components/message.js");
/* harmony import */ var _components_stats_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/stats.js */ "./src/components/stats.js");
/* harmony import */ var _controllers_trip__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/trip */ "./src/controllers/trip.js");
/* harmony import */ var _models_events_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/events.js */ "./src/models/events.js");
...
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_8__["default"](AUTHORIZATION, URL);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_9__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_10__["default"](api, store);

const eventsModel = new _models_events_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

const tripMainElement = document.querySelector(`.trip-main`);
const tripControlsElement = tripMainElement.querySelector(`.trip-controls`);
const tripEventsElement = document.querySelector(`.trip-events`);

const menuComponent = new _components_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const messageComponent = new _components_message_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const tripDaysListComponent = new _components_trip_days_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const statsComponent = new _components_stats_js__WEBPACK_IMPORTED_MODULE_4__["default"](eventsModel);
const tripInfoComponent = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_0__["default"](eventsModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(tripMainElement, tripInfoComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTERBEGIN);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(tripControlsElement, menuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTERBEGIN);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(tripEventsElement, messageComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTERBEGIN);
...
menuComponent.setOnChange((menuItem) => {
  ...
  switch (menuItem) {
    case _components_menu_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE:
...
apiWithProvider
  ...
  .then((events) => {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(messageComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventsModel; });
...
class EventsModel {
  constructor() {
    ...
    this._destinations = [];
    this._offers = [];
    this._activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterName"].EVERYTHING;
    this._activeSort = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortName"].EVENT;
  ...
  getEvents() {
    ...
    const events = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["addDayProperty"])(this._events);
    const filteredEvents = Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getFilteredEvents"])(events, this._activeFilter);
    const sortedEvents = Object(_utils_sort_js__WEBPACK_IMPORTED_MODULE_2__["sortEvents"])(filteredEvents, this._activeSort);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatTime, getDateTime, getDuration, getFormattedDuration, createElement, createSortedByDateObject, createPreposition, makeFirstLetterUppercase, addDayProperty, findDestination, findOffers */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSortedByDateObject", function() { return createSortedByDateObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createPreposition", function() { return createPreposition; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addDayProperty", function() { return addDayProperty; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findDestination", function() { return findDestination; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findOffers", function() { return findOffers; });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
...
moment_duration_format__WEBPACK_IMPORTED_MODULE_2___default()(moment__WEBPACK_IMPORTED_MODULE_1___default.a);

const formatTime = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`hh:mm`);
};

const getDateTime = (date, isReversed = false) => {
  const dateString = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`DD/MM/YYYY`);
  const dateStringReversed = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`YYYY/MM/DD`);

  return isReversed ? dateString : dateStringReversed;
};

const getDuration = (startDate, endDate) => {
  const date1 = moment__WEBPACK_IMPORTED_MODULE_1___default()(startDate);
  const date2 = moment__WEBPACK_IMPORTED_MODULE_1___default()(endDate);
  const duration = moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(date2.diff(date1));
...
const createSortedByDateObject = (events) => {
...
const createPreposition = (eventName) => {
  if (_const_js__WEBPACK_IMPORTED_MODULE_0__["EventType"][eventName.toUpperCase()] === `stop`) {
    return `in`;
  }
...
const makeFirstLetterUppercase = ([first, ...rest]) => [first.toUpperCase(), ...rest].join(``);

const addDayProperty = (events) => {
...
const findDestination = (destinations, name) => {
  return destinations.find((destination) => destination.name === name);
};

const findOffers = (offers, type) => {
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getFilteredEvents, getDisabledFilters */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilteredEvents", function() { return getFilteredEvents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDisabledFilters", function() { return getDisabledFilters; });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
...
const getFutureEvents = (events) => {
  return events.filter((event) => moment__WEBPACK_IMPORTED_MODULE_1___default()(event.startDate).isAfter());
};

const getPastEvents = (events) => {
  return events.filter((event) => moment__WEBPACK_IMPORTED_MODULE_1___default()(event.endDate).isBefore());
};

const getFilteredEvents = (events, filter) => {
  switch (filter) {
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterName"].EVERYTHING:
      return events;
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterName"].FUTURE:
      return getFutureEvents(events);
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterName"].PAST:
...
const getDisabledFilters = (events) => {
  return {
    [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterName"].EVERYTHING]: events.length === 0,
    [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterName"].FUTURE]: getFutureEvents(events).length === 0,
    [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterName"].PAST]: getPastEvents(events).length === 0
  };
};
...
const sortEvents = (events, sortType) => {
  ...
  switch (sortType) {
    ...
    case _const__WEBPACK_IMPORTED_MODULE_0__["SortName"].EVENT:
      return sortedEvents;
    case _const__WEBPACK_IMPORTED_MODULE_0__["SortName"].TIME:
      return sortedEvents.sort(({startDate: startDate1, endDate: endDate1}, {startDate: startDate2, endDate: endDate2}) => {
        const duration1 = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(startDate1, endDate1);
        const duration2 = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(startDate2, endDate2);

        return duration2.asMilliseconds() - duration1.asMilliseconds();
      });
    case _const__WEBPACK_IMPORTED_MODULE_0__["SortName"].PRICE:
